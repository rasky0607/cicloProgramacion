/*
 Autor: Pablo Lopez
 Ejemplo consola:Insertar un dato en una posicion determinada del array, y borrar dato de un array en uan posicion determinada
 Fecha:27/11/2017
 */
using System;
...
namespace AppInsertarArryYBorrar.pbl
{
    class Program
    {
